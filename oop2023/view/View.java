...
public class View {
    ...
    public void printHelpInfo() {
        ...
        System.out.println("=> \"orderStatus номер_заказа\" - статус заказ");
    ...
    public void printInvalidInput() {
        ...
        System.err.println("=> Для просмотра доступных команд введите help");
    }

    public void printMenu(List<PizzaModel> menu) {
        menu.forEach(i -> {
    ...
    public void printChangeStatusSuccess(OrderModel order) {
        System.out.println("=> Статус заказа " + order.getId() + " изменен на " + ORDER_STATUS_NAMES.get(order.getStatus()));
    }
}
